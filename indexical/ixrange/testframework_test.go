...
func resultSet_test(t *testing.T, test string, resultSet map[int]map[core.VarId]int,
...
func log(msgs ...string) {
	loglevel := test_logger.GetLoggingLevel()
	test_logger.SetLoggingLevel(core.LOG_INFO)
	for _, msg := range msgs {
		test_logger.Iln(msg)
	}
	test_logger.SetLoggingLevel(loglevel)
}
