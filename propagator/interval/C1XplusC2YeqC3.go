...
// C1XplusC2YeqC3 represents the constraint C1*X + C2*Y = C3*Z,
// i.e. 3*X+2*Y=5*Z. Its propagate functions establish arc consistency
...
func CreateC1XplusC2YeqC3(c1 int, x core.VarId, c2 int, y core.VarId, c3 int) *C1XplusC2YeqC3 {
	if core.GetLogger().DoDebug() {
