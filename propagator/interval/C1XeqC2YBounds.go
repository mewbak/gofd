...
// C1XeqC2YBounds represents the constraint C1*X=C2*Y, i.e.: X*3=Y*1. Its
// propagate functions establish bounds consistency
...
func (this *C1XeqC2YBounds) Start() {
...
func (this *C1XeqC2YBounds) makeBoundConsistent(evt *core.ChangeEvent) bool {
	...
	if possmax < this.c2*ymax || possmin > this.c2*ymin {
		for k := range this.y_Domain.Values_asMap() {
...
func CreateC1XeqC2YBounds(c1 int, x core.VarId, c2 int, y core.VarId) *C1XeqC2YBounds {
	if core.GetLogger().DoDebug() {
		core.GetLogger().Dln("CreateC1XeqC2YBounds_propagator")
	}
	prop := new(C1XeqC2YBounds)
	prop.x = x
	prop.y = y
...
func CreateCXeqYBounds(c1 int, x core.VarId, y core.VarId) *C1XeqC2YBounds {
	if core.GetLogger().DoDebug() {
		core.GetLogger().Dln("CreateCmultXeqYBounds_propagator")
	}
	prop := new(C1XeqC2YBounds)
	prop.x = x
	prop.y = y
