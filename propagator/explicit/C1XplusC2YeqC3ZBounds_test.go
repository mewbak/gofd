...
func Test_C1XplusC2YeqC3ZBoundsa(t *testing.T) {
	setup()
	defer teardown()
...
func Test_C1XplusC2YeqC3ZBoundsb(t *testing.T) {
	setup()
	defer teardown()
...
func Test_C1XplusC2YeqC3ZBoundsc(t *testing.T) {
	setup()
	defer teardown()
...
func Test_C1XplusC2YeqC3ZBoundsd(t *testing.T) {
	setup()
	defer teardown()
...
func Test_C1XplusC2YeqC3ZBoundse(t *testing.T) {
	setup()
	defer teardown()
...
func Test_C1XplusC2YeqC3ZBoundsf(t *testing.T) {
	setup()
	defer teardown()
